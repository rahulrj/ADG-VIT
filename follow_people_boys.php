...
$query2="Select registration.username, registration.user_id from Personal_Info INNER JOIN registration on Personal_Info.user_id=registration.user_id where Personal_Info.sex='M' and NOT registration.user_id = '$user_id'";
