...
<form style="margin-top:160px;" method="post" name="regform" action="http://adgvit.in/iwp/register.php" enctype="multipart/form-data" class="login">
    <p>
      <label for="login" style="margin-left:50px;">Username:</label>
      <input type="text" name="username" id="login" placeholder="USERNAME">
    </p>

    <p>
      <label for="password" style="margin-left:55px;">Password:</label>
    ...
    <input type="submit" class="button" style="margin-top:50px;margin-left:150px;" value="Register" name="register" id="register" onclick="return validateform()" />
</p>
