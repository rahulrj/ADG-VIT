...
<label id="webname" style="font-size:40px;color:white;"> Vit Social Network </label>
  ...
  <form name="loginform" method="post" action="http://adgvit.in/iwp/sample.php" class="login" style="margin-top:10%;">
    <p>
      <label for="login" style="margin-left:20px;">Email:</label>
      <input type="text" name="login_username" id="login" placeholder="USERNAME">
    </p>
    ...
    <p >
      <button type="submit" class="button" onclick="return loginvalidate()" style="width:25%;margin-left:80px;">Login</button>
    </p>

    </form>
    <form action="http://www.adgvit.in/iwp/index2.php" method="post" >
    <div id="mydiv" class="login" style="padding-left:100px;">
    <p  >Are you a new User?</p>
      <p >
      <button type="submit" class="button" style="margin-left:40px;width:100px;">Register   </p>
      </div>
</form>
<?php
