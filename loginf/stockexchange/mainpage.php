...
<fieldset>
<form name="loginform" class="elements" style="float:none" method="post" action="http://adgvit.in/stockexchange/login.php" >
...
<fieldset>
<form name="regform" class="elements" style="float:none"  method="post" action="http://adgvit.in/stockexchange/register.php">
